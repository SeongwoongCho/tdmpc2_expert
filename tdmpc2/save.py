...
data_root="/data1/seongwoongjo/DATA_DMC_RANDOMACTION_ACTIONMASK"
    ...
    for task_idx, task in enumerate(tasks):
        ...
        for i in tqdm(range(cfg.eval_episodes)):
            ...
            while not done:
                ...
                t += 1
                raw_obs = env.unwrapped._env._env._env._env.task.get_observation(env.unwrapped._env._env._env._env.physics)
                state = env.unwrapped._env._env._env._env._physics.get_state() # np.ndarray
